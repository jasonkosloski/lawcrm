...
CREATE TABLE "new_matters" (
    ...
    "billingMode" TEXT NOT NULL DEFAULT 'client',
...
CREATE TABLE "new_practice_areas" (
    ...
    "defaultBillingMode" TEXT NOT NULL DEFAULT 'client',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_practice_areas" ("color", "createdAt", "hasStatuteOfLimitations", "id", "isActive", "label", "name", "order", "updatedAt") SELECT "color", "createdAt", "hasStatuteOfLimitations", "id", "isActive", "label", "name", "order", "updatedAt" FROM "practice_areas";

...
INSERT INTO "new_time_entries" ("activity", "amount", "billable", "calendarEventId", "createdAt", "date", "deadlineId", "hours", "id", "invoiceId", "matterId", "narrative", "noCharge", "noteId", "privileged", "rate", "source", "sourceRef", "status", "taskId", "updatedAt", "userId", "utbmsCode") SELECT "activity", "amount", "billable", "calendarEventId", "createdAt", "date", "deadlineId", "hours", "id", "invoiceId", "matterId", "narrative", "noCharge", "noteId", "privileged", "rate", "source", "sourceRef", "status", "taskId", "updatedAt", "userId", "utbmsCode" FROM "time_entries";

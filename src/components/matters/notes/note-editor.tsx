/**
 * Note Editor — Tiptap wrapper.
 *
 * Thin client-only wrapper around Tiptap's useEditor. Emits HTML on
 * change via `onUpdate`; the surrounding form posts the HTML string
 * to the server action where it's sanitized before insert.
 *
 * Toolbar exposes the handful of marks/nodes we care about for
 * internal-use notes (headings, bold, italic, strike, inline code,
 * block code, blockquote, lists). No images/tables — this is a
 * workspace note, not a document editor.
 */

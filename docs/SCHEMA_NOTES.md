...
49 models as of 2026-07-07: the initial 2026-04-24 snapshot plus everything added since (second table). When you add a model, add a row to the second table AND a changelog entry.
